...
import {allAnimal, shelters, fetchAnnouncements, fetchAllAnimals} from "../../../api";
...
const Chart = () => {
    ...
    useEffect(() => {
        const getAllAnimals = async () => {
            const allAnimals = await fetchAllAnimals().then(resolve => resolve.data);
