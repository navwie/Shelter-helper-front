...
import del from '../../img/icons8-удалить-100.png';
                            ...
                            <div className={styles.cardBody}>
                                ...
                                <div className={styles.cardInfo}>
                                    ...
                                    <div className={styles.btn}>
                                        <a onClick={() => submitArchive(animal.id)}> <img src={del} className={styles.img} alt="logo"/></a>
                                        <a href={`/editAnimal/` + animal.id}> <img src={update} className={styles.img} alt="logo"/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
